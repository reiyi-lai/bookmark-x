...
class KeywordMatcher {
  ...
  static getKeywordSets(): Record<string, string[]> {
    return {
      ...
      'career prep': ['job', 'career', 'interview', 'resume',
                     'workplace', 'skills', 'networking', 'salary', 'negotiation',
                     'cv', 'interview prep', 'tech interview', 'coding interview', 'system design',
                     'leetcode', 'algorithms', 'data structures',
                     'technical interview', 'phone screen', 'onsite interview',
                     'mock interview', 'interview questions', 'interview tips', 'job search'],
